...
def for_sliding_window(binary_warped):
    ...
    # TODO FIX
    # TODO the 30 and 3.7 while not image dependant are road dependant see Measuring Curvature II for more details
    # TODO it looks like perspective transform might have an effect
